...
const AdminLayout = ({ children }) => {
  ...
  const navigation = [
    ...
    { name: 'Residents', href: '/admin/residents', icon: FaUsers },
    { name: 'Digital IDs', href: '/admin/digital-ids', icon: FaIdCard },
  ...
  return (
    <div className="flex h-screen bg-gray-100">
      ...
      <div className="hidden lg:flex">
        <div className="flex flex-col w-64 bg-gradient-to-b from-slate-50 to-white shadow-2xl border-r border-gray-100">
          ...
          <div className="flex items-center justify-center h-20 bg-gradient-to-r from-emerald-600 via-teal-600 to-emerald-700 relative overflow-hidden">
            ...
            <div className="flex items-center space-x-3 relative z-10 animate-fade-in">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-emerald-100 text-xs font-medium">Admin Panel</span>
              </div>
            </div>
          </div>
          ...
          <nav className="flex-1 px-6 py-8 space-y-3">
            <div className="mb-4">
              <h3 className="text-xs font-semibold text-gray-500 uppercase tracking-wider px-2 mb-3 animate-fade-in">Admin Navigation</h3>
            </div>
          ...
          <div className="p-6 border-t border-gray-100 bg-gradient-to-r from-gray-50 to-slate-50">
            <div className="flex items-center mb-4 p-3 bg-white rounded-xl shadow-sm border border-gray-100 transform transition-all duration-300 hover:shadow-md hover:scale-[1.02]">
              <div className="w-12 h-12 bg-gradient-to-br from-emerald-100 to-teal-100 rounded-xl flex items-center justify-center border border-emerald-200 transition-all duration-300 hover:rotate-[5deg] hover:scale-110">
                <span className="text-emerald-700 font-bold text-lg">AD</span>
              </div>
      ...
      <div className={`${isSidebarOpen ? 'block' : 'hidden'} fixed inset-0 z-40 lg:hidden`}>
        <div className="flex h-full">
          <div className="flex flex-col w-64 bg-gradient-to-b from-slate-50 to-white shadow-2xl border-r border-gray-100 animate-slide-in-left">
            {/* Mobile Logo */}
            <div className="flex items-center justify-center h-20 bg-gradient-to-r from-emerald-600 via-teal-600 to-emerald-700 relative overflow-hidden">
              <div className="absolute inset-0 bg-white/10 backdrop-blur-sm"></div>
            ...
            <nav className="flex-1 px-6 py-8 space-y-3">
              <div className="mb-4">
                <h3 className="text-xs font-semibold text-gray-500 uppercase tracking-wider px-2 mb-3">Admin Navigation</h3>
              </div>
              {navigation.map((item, index) => {
                const IconComponent = item.icon
                const isActive = location.pathname === item.href
                return (
                  <Link
                    ...
                    className={`group flex items-center px-4 py-3.5 text-sm font-medium rounded-xl transition-all duration-300 ease-out relative transform hover:scale-[1.02] active:scale-[0.98] ${
                      isActive
                        ? 'bg-gradient-to-r from-emerald-50 to-teal-50 text-emerald-700 shadow-lg border border-emerald-100 scale-[1.02]'
                        : 'text-gray-600 hover:bg-gradient-to-r hover:from-gray-50 hover:to-slate-50 hover:text-gray-900 hover:shadow-md'
                    }`}
          ...
          <div className="flex items-center justify-between px-6 py-4">
            <div className="flex items-center space-x-4">
              <button
                ...
                className="lg:hidden p-2.5 rounded-xl text-gray-400 hover:text-gray-600 hover:bg-gray-100 transition-all duration-300 transform hover:scale-110 active:scale-95"
              >
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="hidden sm:flex items-center space-x-3 px-3 py-2 bg-emerald-50 rounded-xl border border-emerald-100">
                <div className="w-8 h-8 bg-gradient-to-br from-emerald-100 to-teal-100 rounded-lg flex items-center justify-center border border-emerald-200">
                  <span className="text-emerald-700 font-bold text-sm">AD</span>
                </div>
                <div className="text-sm">
                  <p className="font-medium text-gray-900">Administrator</p>
                  <p className="text-emerald-600 text-xs">System Admin</p>
                </div>
              </div>
            </div>
          </div>
