...
const UserLayout = ({ children }) => {
  ...
  const displayName = user?.resident?.firstName && user?.resident?.lastName 
            ...
            <div className="flex items-center mb-4 p-3 bg-white rounded-xl shadow-sm border border-gray-100 transform transition-all duration-300 hover:shadow-md hover:scale-[1.02]">
              ...
              <div className="ml-3 flex-1">
                ...
                <p className="text-xs text-gray-500 flex items-center">
                  ...
                  {user?.resident?.status === 'verified' ? 'Verified Resident' : 'Pending Verification'}
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4">
              <div className="animate-fade-in">
                <h1 className="text-xl font-semibold text-gray-900">
                  Welcome back, {user?.resident?.firstName || 'User'}!
                </h1>
                <p className="text-sm text-gray-600">
                  Manage your digital ID and access barangay services
                </p>
              </div>
            </div>
